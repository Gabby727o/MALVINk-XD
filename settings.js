...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "MALVIN-XD~IghTAaCZ#I12i8ibtgQaBuU8Kfpc68bEvlhE5lVvO8twwe_oyb40",
// add your Session Id 

PREFIX: process.env.PREFIX || ".",
// add your prifix for bot

BOT_NAME: process.env.BOT_NAME || "sophia",
// add bot name here for menu

CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
// make this true for custum emoji react   

STICKER_NAME: process.env.STICKER_NAME || "SOPHIA-MD",
...
OWNER_NAME: process.env.OWNER_NAME || "kwame",
// add bot owner name

DESCRIPTION: process.env.DESCRIPTION || "kwame",
// add bot owner name    
...
FAKE_RECORDING: process.env.FAKE_RECORDING || "truee",
...
DEV: process.env.DEV || "23532871325",
